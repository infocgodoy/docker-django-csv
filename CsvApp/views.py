...
def export(request):
    ...
    #cur.execute('SELECT model as sku,((CASE WHEN category_5_1 != 0 and category_5_2 != 0 and category_5_3 != 0 THEN "default/"||category_5_1||","||"default/"||category_5_1||"/"||category_5_2||","||"default/"||category_5_1||"/"||category_5_2||"/"||category_5_3||"," END)||(CASE WHEN category_6_1 != 0 and category_6_2 != 0 and category_6_3 != 0 THEN "default/"||category_6_1||","||"default/"||category_6_1||"/"||category_6_2||","||"default/"||category_6_1||"/"||category_6_2||"/"||category_6_3 WHEN category_7_1 != 0 and category_7_2 != 0 and category_7_3 != 0 THEN "default/"||category_7_1||","||"default/"||category_7_1||"/"||category_7_2||","||"default/"||category_7_1||"/"||category_7_2||"/"||category_7_3 WHEN category_8_1 != 0 and category_8_2 != 0 and category_8_3 != 0 THEN "default/"||category_8_1||","||"default/"||category_8_1||"/"||category_8_2||","||"default/"||category_8_1||"/"||category_8_2||"/"||category_8_3 END)) as categories FROM master_products_configurable group by model')
...
def servicios(request):
    ...
    return render(request, "CsvApp/servicios.html")